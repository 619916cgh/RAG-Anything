...
export default function App() {
  ...
  const cockpitStats = [
    { label: '文档', value: stats.documents, icon: Zap, tone: 'blue' },
    { label: '实体', value: stats.entities, icon: Cpu, tone: 'green' },
    { label: '关系', value: stats.relations, icon: Hash, tone: 'amber' },
  ]
    ...
    <div className="min-h-screen bg-cloud-100 app-shell cockpit-shell">
      ...
      <header className="cockpit-topbar">
        ...
        <div className="cockpit-topbar-actions">
          <div className="cockpit-stat-strip">
